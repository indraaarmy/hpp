Public Class Pembuatan_stample

    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Dim iROW As Integer
        create("INSERT INTO sk_produk (id_produk,id_sk, waktu, jumlah_pekerja, upah) VALUES ( ( SELECT x.id FROM (SELECT MAX(t.id_produk) AS id FROM produk t) x),5,'" + waktu.Text + "','" + jumlah_pekerja.Text + "','" + upah.Text + "')")
    ...
    Private Sub Pembuatan_stample_Shown(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Shown
        Try
