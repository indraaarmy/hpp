...
Public Class Cetak_laporan_kebutuhan_SK
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Cetak_laporan_kebutuhan_SK.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "hpp.Cetak_laporan_kebutuhan_SK.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_id_produk() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCetak_laporan_kebutuhan_SK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cetak_laporan_kebutuhan_SK = New Cetak_laporan_kebutuhan_SK
        rpt.Site = Me.Site
        Return rpt
    End Function
